...
Route::delete('/api/v1/restricted/place/delete/{id}', ['uses' =>'PlaceController@PlaceDelete']);
...
Route::delete('/api/v1/restricted/category/delete/{id}', ['uses' =>'PlaceController@CategoryDelete']);
